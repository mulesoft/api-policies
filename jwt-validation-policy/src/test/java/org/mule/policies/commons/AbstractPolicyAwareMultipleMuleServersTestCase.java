...
public abstract class AbstractPolicyAwareMultipleMuleServersTestCase extends AbstractMultipleFakeMuleServersTestCase
{
    ...
    protected class AssertEndpointResponseBuilder
    {
		...
		public AssertEndpointResponseBuilder setUnExpectedResponseHeaders(
				List<String> unExpectedResponseHeaders) {
			this.unexpectedResponseHeaders = unExpectedResponseHeaders;
			return this;
		}
    }
