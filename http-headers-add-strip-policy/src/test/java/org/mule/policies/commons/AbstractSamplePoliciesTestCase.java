...
public abstract class AbstractSamplePoliciesTestCase extends AbstractStandalonePolicyAwareTestCase
{
    ...
    @Rule
    public DynamicPort autoDiscoveryPort = new DynamicPort("auto_api_port");

        
    @Rule
    public SystemProperty systemProperty;

    protected String apiFile, proxyFile, autoDiscoveryFile;    

    public AbstractSamplePoliciesTestCase(String proxyFile, String apiFile, String autoDiscoveryFile, boolean nonBlocking)
    {
        this.apiFile = apiFile;
        this.proxyFile = proxyFile;
        this.autoDiscoveryFile = autoDiscoveryFile;
        if (nonBlocking)
        {
    ...
    protected List<FakeMuleApplication> getApplications()
    {
        ...
        return Arrays.asList(
        					new FakeMuleApplication("api", new String[] {apiFile}),
        					 new FakeMuleApplication("proxy", new String[] {proxyFile}),
        					 new FakeMuleApplication("auto_discovery_proxy", new String[] {autoDiscoveryFile})
        					);
    }
