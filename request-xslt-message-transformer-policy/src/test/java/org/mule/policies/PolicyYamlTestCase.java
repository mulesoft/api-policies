...
public class PolicyYamlTestCase {
	...
	private String name = "Request XSLT Message Transformer Policy";
	private String description = "Modifies the API's requests based on the provided XSLT transformation.";
	...
	public void prepare(){
		...
		expectedParameters.put("xslt", 
				...
				.withSensitive(false)
				.withName("XSLT")
				.withDescription("XSLT used for incoming messages")
		...
		expectedParameters.put("mimetype", 
				...
				.withName("MimeType for the messages")
				.withDescription("MimeType for the transformed messages")
		...
		expectedParameters.put("encoding", 
				...
				.withName("Encoding for the message")
				.withDescription("Encoding for the transformed messages")
